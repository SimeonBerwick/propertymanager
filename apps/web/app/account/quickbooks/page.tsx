...
import { disconnectQuickBooksAction, saveQuickBooksSettingsAction } from './actions'
  ...
  return <main className="stack">
    ...
    {!connection ? <section className="card stack">
      ...
      <section className="card stack">
        ...
        <div className="row" style={{ justifyContent: 'flex-start' }}><a href="/api/quickbooks/connect" className="button">Reconnect</a><form action={disconnectQuickBooksAction}><button className="button" type="submit">Disconnect</button></form></div>
      </section>
