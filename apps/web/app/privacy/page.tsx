  ...
  return (
    <main className="stack" style={{ maxWidth: 920, margin: '0 auto' }}>
      ...
      <section className="card stack">
        ...
        <p className="muted" style={{ margin: 0 }}>
          We collect account and contact information such as names, email addresses, property or unit details, tenant access information, vendor details, maintenance request descriptions, status updates, comments, photos, billing records, and operational audit events.
        </p>
        <p className="muted" style={{ margin: 0 }}>
          When connected by a property manager, the service may use mailbox integrations to send maintenance updates and sync related replies. Payment processing is handled by Stripe when subscriptions are enabled.
        </p>
      </section>
      ...
      <section className="card stack">
        ...
        <p className="muted" style={{ margin: 0 }}>
          We use information to operate the maintenance workflow, route requests, notify users, manage access, keep request history, support vendor coordination, generate operational reports, process subscriptions, prevent abuse, and improve reliability.
        </p>
      </section>
      ...
      <section className="card stack">
        ...
        <p className="muted" style={{ margin: 0 }}>
          We do not sell personal information. We share information with service providers only as needed to run the product, including hosting, database, storage, email delivery, authentication, analytics or logging, and payment processing providers.
        </p>
      </section>
