  ...
  return (
    <main className="stack" style={{ maxWidth: 760, margin: '0 auto' }}>
      <section className="card stack">
        ...
        <p className="muted" style={{ margin: 0 }}>
          Property managers should sign in to use the in-account request form when possible, and should cancel any active subscription before requesting deletion. Tenants and vendors should email support from the address linked to their portal account. Support will confirm the records that can be deleted and when deletion is complete.
        </p>
        {session ? (
