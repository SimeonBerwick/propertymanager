...
export ANDROID_REVIEWER_LANDLORD_PASSWORD="${ANDROID_REVIEWER_LANDLORD_PASSWORD:-local-reviewer-password-not-for-production}"
...
export ANDROID_REVIEWER_STAFF_EMAIL="${ANDROID_REVIEWER_STAFF_EMAIL:-play-review-staff@simeonware.com}"
export ANDROID_REVIEWER_OTP_CODE="${ANDROID_REVIEWER_OTP_CODE:-731946}"
