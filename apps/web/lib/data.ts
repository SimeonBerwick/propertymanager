...
function mapRequestRow(r: any, claimedByUserName?: string): DashboardRequestRow {
  ...
  return {
    ...
    assignedStaffId: r.assignedStaffId ?? undefined,
    assignedStaffName: r.assignedStaffName ?? undefined,
    staffWorkStatus: r.staffWorkStatus ?? undefined,
    staffResponseDueAt: r.staffResponseDueAt?.toISOString() ?? undefined,
