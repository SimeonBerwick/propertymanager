      ...
      const created = await prisma.$transaction(async (tx) => {
        ...
        const created = await tx.maintenanceRequest.create({
          data: {
            ...
            assignedVendorId: plan.preferredVendorId,
            assignedVendorName: plan.preferredVendor?.name,
            assignedVendorEmail: plan.preferredVendor?.email,
            assignedVendorPhone: plan.preferredVendor?.phone,
            dispatchStatus: plan.preferredVendorId ? 'assigned' : null,
